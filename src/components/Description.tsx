            ...
            <div className="mt-8 flex w-5/6 border-b border-[#B2B2B2]">
               <div className="mr-5 flex flex-col max-md:items-center">
                    ...
                    <motion.button 
                        ...
                        className="w-32 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">READ MORE</motion.button>
               </div>
